...
header = "Praise Giving Distribution 2"
description = "We can also take another look at the distribution of the people giving praise."
...
def run(praise_distribution):
  ...
  praise_by_giver.sort_values(by='TOKENS GAVE',inplace=True,ascending=True)
